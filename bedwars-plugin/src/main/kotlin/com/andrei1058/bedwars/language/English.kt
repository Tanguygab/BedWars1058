...
class English : Language(BedWars.INSTANCE, "en", "English") {
    init {
        val bw = BedWars.MAIN_COMMAND

        default(
            Messages.COMMAND_MAIN to listOf(
                "",
                "&2▪ &7/$bw stats",
            ...
            Messages.COMMAND_LANG_LIST_HEADER to "{prefix} &2Available languages:",
            Messages.COMMAND_LANG_LIST_FORMAT to "&a▪  &7{iso} - &f{name}",
            Messages.COMMAND_LANG_USAGE to "{prefix}&7Usage: /lang &f&o<iso>",
            Messages.COMMAND_LANG_SELECTED_NOT_EXIST to "{prefix}&cThis language doesn't exist!",
            Messages.COMMAND_LANG_SELECTED_SUCCESSFULLY to "{prefix}&aLanguage changed!",
            Messages.COMMAND_LANG_USAGE_DENIED to "{prefix}&cYou can't change the language during the game.",

            Messages.COMMAND_JOIN_USAGE to "§a▪ §7Usage: /$bw join §o<arena/group>",
            Messages.COMMAND_JOIN_GROUP_OR_ARENA_NOT_FOUND to "{prefix}&cThere isn't any arena or arena group called: {name}",
            Messages.COMMAND_JOIN_DENIED_IS_FULL to "{prefix}&cThis arena is full!\n&aPlease consider donating for more features. &7&o(click,",
            Messages.COMMAND_JOIN_NO_EMPTY_FOUND to "{prefix}&cThere isn't any arena available right now ;(",
            Messages.COMMAND_JOIN_DENIED_IS_FULL_OF_VIPS to
            ...
            Messages.COMMAND_JOIN_DENIED_PARTY_TOO_BIG to "{prefix}&cYour party is too big for joining this arena as a team :(",
            Messages.COMMAND_JOIN_DENIED_NOT_PARTY_LEADER to "{prefix}&cOnly the leader can choose the arena.",
            Messages.COMMAND_JOIN_PLAYER_JOIN_MSG to "{prefix}&7{player} &ehas joined (&b{on}&e/&b{max}&e,!",
            Messages.COMMAND_JOIN_SPECTATOR_MSG to
                    "{prefix}§6You are now spectating §9{arena}§6.\n{prefix}§eYou can leave the arena at any time doing §c/leave§e.",
            Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG to "&cSpectators are not allowed in this arena!",

            Messages.COMMAND_TP_PLAYER_NOT_FOUND to "{prefix}&cPlayer not found!",
            Messages.COMMAND_TP_NOT_IN_ARENA to "{prefix}&cThis player is not in a bedwars arena!",
            Messages.COMMAND_TP_NOT_STARTED to "{prefix}&cThe arena where the player is didn't start yet!",
            Messages.COMMAND_TP_USAGE to "{prefix}&cUsage: /bw tp <username>",

            Messages.REJOIN_NO_ARENA to "{prefix}&cThere is no arena to rejoin!",
            Messages.REJOIN_DENIED to "{prefix}&cYou can't rejoin the arena anymore. Game ended or bed destroyed.",
            Messages.REJOIN_ALLOWED to "{prefix}&eJoining arena &a{arena}&e!",
            Messages.COMMAND_REJOIN_PLAYER_RECONNECTED to "{prefix}&7{player} &ehas reconnected!",

            Messages.COMMAND_LEAVE_DENIED_NOT_IN_ARENA to "{prefix}&cYou're not in arena!",
            Messages.COMMAND_LEAVE_MSG to "{prefix}&7{player} &ehas quit!",

            Messages.COMMAND_NOT_ALLOWED_IN_GAME to "{prefix}&cYou can't do this during the game.",
            Messages.COMMAND_NOT_FOUND_OR_INSUFF_PERMS to "{prefix}&cCommand not found or you don't have permission!"
        )
        addDefault(
        ...
        mapOf(
            ...
            "2" to "&c❷",
            "1" to "&c❶"
        ).forEach { (second, display) -> addDefault("${Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE}-$second", display) }
