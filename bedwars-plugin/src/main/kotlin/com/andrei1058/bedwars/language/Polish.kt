...
class Polish : Language(BedWars.INSTANCE, "pl", "Polski") {
    init {
        val bw = BedWars.MAIN_COMMAND

        options().setHeader(listOf("Polish translation by RarstManPL#0616 and Creper132#7570 Updated by Seriously Not Beluga#0082"))

        addDefault(Messages.COMMAND_JOIN_USAGE, "§a▪ §7Uzyj: /$bw join §o<arena/grupa>")
        addDefault(Messages.COMMAND_NOT_ALLOWED_IN_GAME, "{prefix}&cNie mozesz tego zrobic.")
        addDefault(
        ...
        addDefault(Messages.COMMAND_LEAVE_MSG, "{prefix}&7{player} &eopuscil gre!")
        addDefault(
            Messages.COMMAND_JOIN_GROUP_OR_ARENA_NOT_FOUND,
            "{prefix}&cNie istnieje zadna arena o nazwie: {name}"
        )
        addDefault(Messages.COMMAND_JOIN_NO_EMPTY_FOUND, "{prefix}&cObecnie nie ma zadnej dostepnej areny ;(")
        addDefault(Messages.COMMAND_LEAVE_DENIED_NOT_IN_ARENA, "{prefix}&cNie jestes na arenie!")
        addDefault(Messages.COMMAND_LANG_LIST_HEADER, "{prefix} &2Dostepne jezyki:")
        addDefault(Messages.COMMAND_LANG_LIST_FORMAT, "&a▪  &7{iso} - &f{name}")
        addDefault(Messages.COMMAND_LANG_USAGE, "{prefix}&7Uzyj: /lang &f&o<iso>")
        addDefault(Messages.COMMAND_LANG_SELECTED_NOT_EXIST, "{prefix}&cTen jezyk nie jest dostepny na serwerze!")
        addDefault(Messages.COMMAND_LANG_SELECTED_SUCCESSFULLY, "{prefix}&aJezyk zostal zmieniony!")
        addDefault(Messages.COMMAND_TP_PLAYER_NOT_FOUND, "{prefix}&cNie znaleziono gracza!")
        addDefault(Messages.COMMAND_TP_NOT_IN_ARENA, "{prefix}&cTego gracza nie ma na arenie!")
        addDefault(
            Messages.COMMAND_TP_NOT_STARTED,
            "{prefix}&cArena na której jest ten gracza, jeszcze się nie rozpoczeła!"
        )
        addDefault(Messages.COMMAND_TP_USAGE, "{prefix}&cUzycie: /bw tp <gracz>")
        addDefault(Messages.COMMAND_REJOIN_PLAYER_RECONNECTED, "{prefix}&7{player} &eponownie się połączył!")
        addDefault(Messages.COMMAND_LANG_USAGE_DENIED, "{prefix}&cNie mozesz zmienic jezyka podczas gry.")
        addDefault(
            Messages.COMMAND_JOIN_DENIED_PARTY_TOO_BIG,
            "{prefix}&cTwoje party jest zbyt duze abo dolaczyc do tej areny w pelnym skladzie :("
        )
        addDefault(Messages.COMMAND_JOIN_DENIED_NOT_PARTY_LEADER, "{prefix}&cTylko lider party moze wybrac arene.")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_INVITE_USAGE, "{prefix}&eUzyj: &7/party invite <nick>")
        addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player} &ejest offline!")
        addDefault(Messages.COMMAND_PARTY_INVITE_SENT, "{prefix}&eZaprosiles gracza &7{player}&6.")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_ACCEPT_DENIED_ALREADY_IN_PARTY, "{prefix}&eJuz jestes w party!")
        addDefault(Messages.COMMAND_PARTY_INSUFFICIENT_PERMISSIONS, "{prefix}&cTylko lider party moze to zrobic!")
        addDefault(Messages.COMMAND_PARTY_ACCEPT_USAGE, "{prefix}&eUzyj: &7/party accept <nick>")
        addDefault(Messages.COMMAND_PARTY_ACCEPT_SUCCESS, "{prefix}&7{player} &edolaczyl do party!")
        addDefault(Messages.COMMAND_PARTY_GENERAL_DENIED_NOT_IN_PARTY, "{prefix}&cNie jestes w party!")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_LEAVE_SUCCESS, "{prefix}&7{player} &eopuscil party!")
        addDefault(Messages.COMMAND_PARTY_DISBAND_SUCCESS, "{prefix}&eParty zostalo rozwiazane!")
        addDefault(Messages.COMMAND_PARTY_REMOVE_USAGE, "{prefix}&7Uzyj: &e/party remove <nick>")
        addDefault(Messages.COMMAND_PARTY_REMOVE_SUCCESS, "{prefix}&7{player} &ezostal wyrzucony z party.")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_PROMOTE_OWNER, "{prefix}&eZostałeś awansowany na właściciela grupy")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_INFO_PLAYERS, "{prefix}&eCzłonkowie grupy to:")
        ...
        addDefault(Messages.COMMAND_FORCESTART_NOT_IN_GAME, "§c▪ §7Nie jestes w zadnej grze!")
        addDefault(Messages.COMMAND_FORCESTART_SUCCESS, "§c▪ §7Odliczanie zostalo skrocone!")
        addDefault(
        ...
        addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player} &ejest offline!")
        addDefault(Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG, "&cWidzowie nei mają wstępu na tę arene!")
        addDefault(Messages.COMMAND_COOLDOWN, "&cNie możesz tego zrobić! Poczekaj {seconds}!")
        ...
        addDefault(Messages.ARENA_SPECTATOR_LEAVE_ITEM_NAME, "&c&lPowroc do lobby")
        addDefault(
            Messages.ARENA_SPECTATOR_LEAVE_ITEM_LORE,
            listOf("&7Kliknij PPM aby wyjsc do lobby!")
        )
        addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_ENTER_TITLE, "&aObserwujesz &7{player}")
        addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_ENTER_SUBTITLE, "&cKUCNIJ aby wyjść")
        addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_LEAVE_TITLE, "&eWychodzisz z trybu widza!")
        ...
        addDefault(Messages.ARENA_RESTART_PLAYER_KICK, "{prefix}&eArena na ktorej jestes zostala zrestartowana.")
        addDefault(Messages.ARENA_STATUS_PLAYING_NAME, "&cGra")
        addDefault(Messages.ARENA_STATUS_RESTARTING_NAME, "&4Restartowanie")
        addDefault(Messages.ARENA_STATUS_WAITING_NAME, "&2Oczekiwanie §c{full}")
        addDefault(Messages.ARENA_STATUS_STARTING_NAME, "&6Rozpoczynanie §c{full}")
        addDefault(Messages.ARENA_GUI_INV_NAME, "&8Dostepne areny")
        ...
        addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CHAT, "{prefix}&eGra zaczyna sie za &6{time} &esekund/y!")
        ...
        addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CANCELLED_SUB_TITLE, "&cCzekamy na więcej graczy...")
        addDefault(
        ...
        addDefault(Messages.GENERATOR_HOLOGRAM_TYPE_DIAMOND, "&b&lDiamentow")
        addDefault(Messages.GENERATOR_HOLOGRAM_TYPE_EMERALD, "&a&lSzmaragdow")
        addDefault(Messages.GENERATOR_HOLOGRAM_TIMER, "&ePojawi sie za &c{seconds} &esekund/y")
        addDefault(
        ...
        addDefault(Messages.FORMATTING_SCOREBOARD_HEALTH, listOf("&c❤", "&aZYCIA"))
        ...
        addDefault(Messages.FORMATTING_ACTION_BAR_TRACKING, "&fSledzenie: {team} &f- Dystans: {distance}m")
        ...
        addDefault(Messages.FORMAT_PAPI_PLAYER_TEAM_SHOUT, "&6[GLOBALNY]")
        addDefault(Messages.FORMAT_PAPI_PLAYER_TEAM_SPECTATOR, "&7[DUCH]")
        addDefault(Messages.MEANING_SHOUT, "okrzyk")
        addDefault(Messages.MEANING_NOBODY, "Nikt")
        addDefault(Messages.MEANING_FULL, "Full")
        addDefault(Messages.MEANING_IRON_SINGULAR, "Zelaza")
        addDefault(Messages.MEANING_IRON_PLURAL, "Zelaza")
        addDefault(Messages.MEANING_GOLD_SINGULAR, "Zlota")
        addDefault(Messages.MEANING_GOLD_PLURAL, "Zlota")
        addDefault(Messages.MEANING_EMERALD_SINGULAR, "Szmaragdow")
        addDefault(Messages.MEANING_EMERALD_PLURAL, "Szmaragdy")
        addDefault(Messages.MEANING_DIAMOND_SINGULAR, "Diamentow")
        addDefault(Messages.MEANING_DIAMOND_PLURAL, "Diamenty")
        addDefault(Messages.MEANING_VAULT_SINGULAR, "$")
        addDefault(Messages.MEANING_VAULT_PLURAL, "$")
        addDefault(Messages.MEANING_NEVER, "NIGDY")
        addDefault(Messages.INTERACT_CANNOT_PLACE_BLOCK, "{prefix}&cNie mozesz tutaj stawiac blokow!")
        addDefault(
            Messages.INTERACT_CANNOT_BREAK_BLOCK,
            "{prefix}&c&cMozesz zniszczyc tylko bloki postawione przez graczy!"
        )
        addDefault(Messages.INTERACT_CANNOT_BREAK_OWN_BED, "&cNie mozesz zniszczyc swojego lozka!")
        addDefault(
        ...
        addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&cLOZKO ZNISZCZONE!")
        addDefault(Messages.INTERACT_BED_DESTROY_SUBTITLE_ANNOUNCEMENT, "&fNie będziesz już się odradzał!")
        addDefault(
        ...
        addDefault(Messages.PLAYER_DIE_VOID_FALL_REGULAR_KILL, "{PlayerColor}{PlayerName} &7spadl do pustki.")
        addDefault(
        ...
        addDefault(Messages.PLAYER_DIE_RESPAWN_TITLE, "&cUMARLES")
        addDefault(Messages.PLAYER_DIE_RESPAWN_SUBTITLE, "&eOdrodzisz sie za &c{time} &esekund/y!")
        addDefault(Messages.PLAYER_DIE_RESPAWN_CHAT, "{prefix}&eOdrodzisz sie za &c{time} &esekund/y!")
        addDefault(Messages.PLAYER_DIE_RESPAWNED_TITLE, "&aODRODZILES SIE!")
        addDefault(Messages.PLAYER_DIE_ELIMINATED_CHAT, "{prefix}&cZostales wyeliminowany!")
        addDefault(Messages.PLAYER_HIT_BOW, "{prefix}{TeamColor}{PlayerName} &7posiada &c{amount} &7HP!")
        addDefault(Messages.PLAYER_DIE_UNKNOWN_REASON_REGULAR, "{PlayerColor}{PlayerName} &7umarl.")
        addDefault(
        ...
        addDefault(Messages.PLAYER_STATS_GUI_INV_NAME, "&8{player} Statystyki")
        addDefault(Messages.GAME_END_GAME_OVER_PLAYER_TITLE, "&c&lPRZEGRANA!")
        addDefault(Messages.GAME_END_VICTORY_PLAYER_TITLE, "&6&lWYGRANA!")
        addDefault(
        ...
        addDefault(Messages.GAME_END_TEAM_WON_CHAT, "{prefix}{TeamColor}{TeamName} &awygral gre!")
        addDefault(Messages.NEXT_EVENT_BEDS_DESTROY, "&dZniszczenie lozek&f:")
        addDefault(Messages.NEXT_EVENT_DIAMOND_UPGRADE_II, "&bDiament &cII&f:")
        addDefault(Messages.NEXT_EVENT_DIAMOND_UPGRADE_III, "&bDiament &cIII&f:")
        addDefault(Messages.NEXT_EVENT_DRAGON_SPAWN, "&cNagla Smierc&f:")
        addDefault(Messages.NEXT_EVENT_EMERALD_UPGRADE_II, "&2Szmaragd &cII&f:")
        addDefault(Messages.NEXT_EVENT_EMERALD_UPGRADE_III, "&2Szmargd &cIII&f:")
        addDefault(Messages.NEXT_EVENT_GAME_END, "&4Koniec gry&f:")
        addDefault(Messages.NEXT_EVENT_TITLE_ANNOUNCE_BEDS_DESTROYED, "&cLOZKO ZOSTALO ZNISZCZONE!")
        addDefault(Messages.NEXT_EVENT_SUBTITLE_ANNOUNCE_BEDS_DESTROYED, "&fWszystkie lozka zostaly zniszczone!")
        addDefault(Messages.NEXT_EVENT_CHAT_ANNOUNCE_BEDS_DESTROYED, "&c&lWszystkie lozka zostaly zniszczone!")
        addDefault(Messages.NEXT_EVENT_TITLE_ANNOUNCE_SUDDEN_DEATH, "&cNagla Smierc")
        ...
        /* Lobby Command Items */
        addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_NAME.replace("%path%", "stats"), "&eStatystyki")
        addDefault(
            Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "stats"),
            listOf("&fKliknij PPM aby zobaczyc swoje statystyki!")
        )
        addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_NAME.replace("%path%", "arena-selector"), "&eAreny")
        addDefault(
            Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "arena-selector"),
            listOf("&fWybierz arene!")
        )
        addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_NAME.replace("%path%", "leave"), "&eWroc do lobby")
        addDefault(
            Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "leave"),
            listOf("&fPPM aby wyjsc do lobby!")
        )
        /* Pre Game Command Items */
        addDefault(Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_NAME.replace("%path%", "stats"), "&eStatystyki")
        addDefault(
            Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_LORE.replace("%path%", "stats"),
            listOf("&fRight-click to see your stats!")
        )
        addDefault(Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_NAME.replace("%path%", "leave"), "&eWroc do lobby")
        addDefault(
        ...
        // end of tab
        addDefault(Messages.XP_REWARD_PER_MINUTE, "{prefix}&6+{xp} Otrzymano doswiedczenie BedWars (Czas grania).")
        addDefault(Messages.XP_REWARD_WIN, "{prefix}&6+{xp} Otrzymano doswiedczenie BedWars (Wygrana gra).")
        addDefault(
        ...
        addDefault(Messages.MONEY_REWARD_PER_MINUTE, "{prefix}&6+{money} Monety (Czas grania).")
        addDefault(Messages.MONEY_REWARD_WIN, "{prefix}&6+{money} Monety (Wygrana gra).")
        addDefault(Messages.MONEY_REWARD_PER_TEAMMATE, "{prefix}&6+{money} Monety (Druzynowa wspolpraca).")
        addDefault(Messages.MONEY_REWARD_BED_DESTROYED, "{prefix}&6+{money} Monety (Zniszczone lozko).")
        addDefault(Messages.MONEY_REWARD_FINAL_KILL, "{prefix}&6+{money} Monety (Finalne zabojstwo).")
        addDefault(Messages.MONEY_REWARD_REGULAR_KILL, "{prefix}&6+{money} Monety (Regularne zabojstwo).")

        addDefault(
            Messages.TEAM_ELIMINATED_CHAT,
            "\n&f&lWYELIMINOWANA DRUZYNA > {TeamColor}{TeamName} &cdruzyna &czostala wyeliminowana!\n"
        )
        addDefault(Messages.BED_HOLOGRAM_DEFEND, "&c&lChron swojego lozka!")
        addDefault(Messages.BED_HOLOGRAM_DESTROYED, "&c&lTwoje lozko zostalo zniszczone!")

        addDefault(Messages.NPC_NAME_TEAM_UPGRADES, "&bDRUZYNOWE ULEPSZENIA,&e&lRIGHT CLICK")
        addDefault(Messages.NPC_NAME_SOLO_UPGRADES, "&bSOLO ULEPSZENIA,&e&lRIGHT CLICK")
        addDefault(Messages.NPC_NAME_TEAM_SHOP, "&bSKLEP Z PRZEDMIOTAMI,&e&lRIGHT CLICK")
        addDefault(Messages.NPC_NAME_SOLO_SHOP, "&bSKLEP Z PRZEDMIOTAMI,&e&lRIGHT CLICK")

        //SHOP
        addDefault(Messages.SHOP_INDEX_NAME, "&8Szybkie kupowanie")
        addDefault(Messages.SHOP_QUICK_ADD_NAME, "&8Dodawanie do szybkiego kupowania")
        addDefault(
            Messages.SHOP_INSUFFICIENT_MONEY,
            "{prefix}&cNie masz wymaganej ilosci {currency}! Potrzebujesz {amount} wiecej!"
        )
        addDefault(Messages.SHOP_NEW_PURCHASE, "{prefix}&aKupiles &6{item}")
        addDefault(Messages.SHOP_ALREADY_BOUGHT, "{prefix}&cJuz to kupiles!")
        addDefault(Messages.SHOP_UTILITY_NPC_SILVERFISH_NAME, "{TeamColor}&l{TeamName} &r{TeamColor}Pluskwa")
        addDefault(Messages.SHOP_UTILITY_NPC_IRON_GOLEM_NAME, "{TeamColor}{despawn}s &8[ {TeamColor}{health}&8]")
        addDefault(Messages.SHOP_SEPARATOR_NAME, "&8⇧ Kategorie")
        addDefault(Messages.SHOP_SEPARATOR_LORE, listOf("&8⇩ Przedmioty"))
        addDefault(Messages.SHOP_QUICK_BUY_NAME, "&bSzybkie kupowanie")
        ...
        addDefault(Messages.SHOP_LORE_STATUS_CAN_BUY, "&eKliknij aby kupić!")
        addDefault(Messages.SHOP_LORE_STATUS_CANT_AFFORD, "&cNie masz wystarczająco {currency}!")
        addDefault(Messages.SHOP_LORE_STATUS_MAXED, "&aMAX!")
        addDefault(Messages.SHOP_LORE_QUICK_ADD, "&bKucnij &7by dodać do szybkiego kupowania")
        addDefault(Messages.SHOP_LORE_QUICK_REMOVE, "&bKucnij &7by usunąć z szybkiego kupowania")
        ...
        addDefault(Messages.UPGRADES_LORE_REPLACEMENT_CLICK_TO_BUY, "&aKliknij aby kupic!")
        addDefault(
            Messages.UPGRADES_LORE_REPLACEMENT_INSUFFICIENT_MONEY,
            "&cBrak odpowiedniej ilosci: &4{currency}"
        )
        addDefault(Messages.UPGRADES_LORE_REPLACEMENT_LOCKED, "&cZABLOKOWANE")
        addDefault(Messages.UPGRADES_LORE_REPLACEMENT_UNLOCKED, "&aODBLOKOWANE")
        addDefault("upgrades.Default.generators.tier1.name", "&eZelazne Ulepszenie")
        addDefault(
        ...
        addDefault("upgrades.Default.generators.tier2.name", "&eZlote Ulepszenie")
        addDefault(
        ...
        addDefault("upgrades.Default.generators.tier3.name", "&eSzmaragdowe Ulepszenie")
        addDefault(
        ...
        addDefault("upgrades.Default.maniacMiner.tier1.name", "&eZwariowany Gornik")
        addDefault(
        ...
        addDefault("upgrades.Default.sharpSword.tier1.name", "&eOstry Miecz")
        addDefault(
        ...
        addDefault("upgrades.Default.reinforced.tier1.name", "&eWzmocniony Pancerz")
        addDefault(
        ...
        addDefault("upgrades.Default.trap.tier1.name", "&eTo jest pulapka!")
        addDefault(
        ...
        addDefault("upgrades.Default.miningFatigue.tier1.name", "&eWyczerpanie gornika")
        addDefault(
        ...
        addDefault("upgrades.Default.healPool.tier1.name", "&ePole Regeneracyjne")
        addDefault(
        ...
        addDefault(Messages.UPGRADES_UPGRADE_BOUGHT_CHAT, "&a{player} kupil &6{upgradeName}")
        ...
        addDefault(Messages.REJOIN_NO_ARENA, "{prefix}&cBrak areny do rejoinu")
        addDefault(Messages.REJOIN_DENIED, "{prefix}&cNie możesz rejoinować!")
        addDefault(Messages.REJOIN_ALLOWED, "{prefix}&eDołączasz do &a{arena}&e!")
        ...
        addDefault(Messages.UPGRADES_TRAP_DEFAULT_TITLE, "&cPULAPKA ZOSTALA URUCHOMIONA!")
