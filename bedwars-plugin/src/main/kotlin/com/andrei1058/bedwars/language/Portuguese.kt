    ...
    init {
        ...
        this.addDefault(
            ...
            listOf(
                "",
                "&7Status: {status}",
                "&7Jogadores: &f{on}&7/&f{max}",
                "&7Tipo: &a{group}",
                "",
                "&aBotão esquerdo para entrar.",
        ...
        addDefaultStatsMsg("deaths", "&6Mortes", "&f{deaths}")
        addDefaultStatsMsg("final-kills", "&6Abates Finais", "&f{finalKills}")
        addDefaultStatsMsg("final-deaths", "&6Mortes Finais", "&f{finalDeaths}")
        addDefaultStatsMsg("beds-destroyed", "&6Camas Destruidas", "&f{bedsDestroyed}")
        addDefaultStatsMsg("first-play", "&6Primeira Partida", "&f{firstPlay}")
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7Clique em um item segurando o",
        ...
        addCategoryMessages(
            ...
            "&8Blocos",
            "&aBlocos",
            listOf("&eClique para ver!")
        )

        addContentMessages(
            this, "wool", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Lã", listOf(
                "&7Preço: &f{cost} {currency}",
                "",
                "&7Ótimo para atravessar ilhas.",
                "&7Transforma-se na cor do seu time.",
                "&7color.",
                "",
                "{quick_buy}",
                "{buy_status}"
        ...
        addContentMessages(
            ...
            "clay",
            ConfigPath.SHOP_PATH_CATEGORY_BLOCKS,
            "{color}Argila Endurecida",
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Bloco básico para defender sua cama.",
                "",
                "{quick_buy}",
                "{buy_status}"
            )
        ...
        addContentMessages(
            ...
            "glass",
            ConfigPath.SHOP_PATH_CATEGORY_BLOCKS,
            "{color}Vidro à prova de explosão",
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Imune a explosões.",
        ...
        addContentMessages(
            ...
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Bloco sólido para defender sua cama.",
                "",
                "{quick_buy}",
                "{buy_status}"
            )
        ...
        addContentMessages(
            ...
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Útil para salvar gatos presos",
                "&7de arvores.",
                "",
                "{quick_buy}",
                "{buy_status}"
        ...
        addContentMessages(
            ...
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Proteção extrema para sua cama.",
                "",
                "{quick_buy}",
                "{buy_status}"
            )
        ...
        addContentMessages(
            ...
            "stone-sword",
            ConfigPath.SHOP_PATH_CATEGORY_MELEE,
            "{color}Espada de Pedra",
            listOf("&7Preço: {cost} {currency}", "", "{quick_buy}", "{buy_status}")
        )
        addContentMessages(
            this,
            "iron-sword",
            ConfigPath.SHOP_PATH_CATEGORY_MELEE,
            "{color}Espada de Ferro",
            listOf("&7Preço: {cost} {currency}", "", "{quick_buy}", "{buy_status}")
        )
        addContentMessages(
            this,
        ...
        addContentMessages(
            ...
            "chainmail",
            ConfigPath.SHOP_PATH_CATEGORY_ARMOR,
            "{color}Armadura de Malha Permanente",
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Calças e botas de malha",
                "&7que você sempre irá renascer",
                "&7com elas.",
                "",
                "{quick_buy}",
                "{buy_status}"
        ...
        addContentMessages(
            ...
            "iron-armor",
            ConfigPath.SHOP_PATH_CATEGORY_ARMOR,
            "{color}Armadura de Ferro Permanente",
            listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Calças e botas de ferro",
                "&7que você sempre irá renascer",
                "com elas.",
                "",
                "{quick_buy}",
        ...
        addContentMessages(
            this, "shears", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}Tesouras Permanentes", listOf(
                "&7Preço: {cost} {currency}",
                "",
                "&7Ótimo para se livrar da lã. Você",
                "&7sempre irá nascer com as tesouras.",
                "",
                "{quick_buy}",
                "{buy_status}"
            )
        ...
        addContentMessages(
            this, "pickaxe", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}Picareta {tier}", listOf(
                "&7Preço: {cost} {currency}",
                "&7Nível: &e{tier}",
                "",
                "&7Este é um item melhorável.",
                "&7Ele perderá 1 nível após.",
                "&7você morer!",
                "",
                "&7Você vai permanentemente",
                "&7renascer com pelo menos o",
                "&7nível mais baixo.",
                "",
                "{quick_buy}",
                "{buy_status}"
        ...
        addContentMessages(
            this, "axe", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}Machado {tier}", listOf(
                "&7Preço: {cost} {currency}",
                "&7Nível: &e{tier}",
                "",
                "&7Este é um item melhorável.",
        ...
        addContentMessages(
            ...
            "speed-potion",
            ConfigPath.SHOP_PATH_CATEGORY_POTIONS,
            "{color}Poção de Agilidade II (45 segundos)",
            listOf("&7Preço: {cost} {currency}", "", "{quick_buy}", "{buy_status}")
        )
        addContentMessages(
            this,
            "jump-potion",
            ConfigPath.SHOP_PATH_CATEGORY_POTIONS,
            "{color}Poção de Super Pulo V (45 segundos)",
            listOf("&7Preço: {cost} {currency}", "", "{quick_buy}", "{buy_status}")
        )
        addContentMessages(
            this,
            "invisibility",
            ConfigPath.SHOP_PATH_CATEGORY_POTIONS,
            "{color}Poção de Invisibilidade (30 segundos)",
            listOf("&7Preço: {cost} {currency}", "", "{quick_buy}", "{buy_status}")
        )
        ...
        addContentMessages(
            this, "bedbug", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Traça", listOf(
                "&7Preço: {cost} {currency}", "", "&7Gera traças onde a bola",
        ...
        addContentMessages(
            ...
            "dream-defender",
            ConfigPath.SHOP_PATH_CATEGORY_UTILITY,
            "{color}Defesa dos Sonhos",
            listOf(
                "&7Preço: {cost} {currency}", "", "&7Golem de Ferro para defender sua",
                "&7base. Dura 4 minutos.", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "fireball", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Bola de Fogo", listOf(
                "&7Preço: {cost} {currency}", "", "&7Botão direito para atirar! Ótimo para",
        ...
        addContentMessages(
            this, "tnt", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}TNT", listOf(
                "&7Preço: {cost} {currency}", "", "&7Explode instantaneamente, apropriado",
                "&7para explodir coisas!", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "ender-pearl", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Pérola do Fim", listOf(
                "&7Preço: {cost} {currency}", "", "&7A maneira mais rápida de invadir",
                "&7a base do inimigo.", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "water-bucket", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Balde de Água", listOf(
                "&7Preço: {cost} {currency}", "", "&7Ótimo para atrasar inimigos. Também",
                "&7protege contra TNT.", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "bridge-egg", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Ovo das Pontes", listOf(
                "&7Preço: {cost} {currency}", "", "&7Este ovo cria uma ponte na",
                "&7direção que for jogada.", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "magic-milk", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Leite Mágico", listOf(
                "&7Preço: {cost} {currency}", "", "&7Evite acionar armadilhas por 60",
                "&7segundos após o consumo.", "", "{quick_buy}", "{buy_status}"
            )
        )
        addContentMessages(
            this, "sponge", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Esponja", listOf(
                "&7Preço: {cost} {currency}", "", "&7Ótimo para absorver a água.",
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7na sua base.",
                "",
                "{tier_1_color}Nível 1: +50% de recursos, &b{tier_1_cost} {tier_1_currency}",
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7encantamento Afiação I permanentemente.",
                "",
                "{tier_1_color}Preço: &b{tier_1_cost} {tier_1_currency}",
                ""
            )
        )
        this.addDefault(
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7proteção em toda a armadura!",
                "",
                "{tier_1_color}Nível 1: Proteção I, &b{tier_1_cost} {tier_1_currency}",
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7ganhar permanentemente Pressa.",
                "",
                "{tier_1_color}Nível 1: Pressa I, &b{tier_1_cost} {tier_1_currency}",
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7em vez de 1 durante o deathmatch!",
                "",
                "{tier_1_color}Preço: &b{tier_1_cost} {tier_1_currency}",
                ""
            )
        ...
        this.addDefault(
            ...
            listOf(
                "",
                "&7A compra de uma armadilha",
                "&7fica nesta fila. Seu custo",
                "&7será com base no número",
                "&7de armadilhas enfileiradas.",
                "",
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7jogadores aliados próximos à sua base.",
                ""
            )
        )
        ...
        this.addDefault(
            ...
            listOf(
                ...
                "&7na sua base com duração de 10 segundos.",
                ""
            )
        )
