package com.andrei1058.bedwars.support.version.v1_17_R1.despawnable
...
abstract class DespawnableProvider<T: LivingEntity>(type: DespawnableType): DespawnableProviderCommon<T>(type) {
    ...
    private fun getGoalSelector(entityLiving: EntityCreature) = entityLiving.bP
    private fun getTargetSelector(entityLiving: EntityCreature) = entityLiving.bQ

    private fun clearSelectors(entityLiving: EntityCreature) {
        getGoalSelector(entityLiving).c().clear()
        getTargetSelector(entityLiving).c().clear()
    }
    ...
    override fun applyDefaultNMSSettings(bukkitEntity: LivingEntity, attr: DespawnableAttributes) {
        ...
        entity.getAttributeInstance(GenericAttributes.a)!!.value = attr.health
        entity.getAttributeInstance(GenericAttributes.d)!!.value = attr.speed
        entity.getAttributeInstance(GenericAttributes.f)!!.value = attr.damage
    }
