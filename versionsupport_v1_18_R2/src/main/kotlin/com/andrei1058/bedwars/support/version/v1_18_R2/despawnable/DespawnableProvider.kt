package com.andrei1058.bedwars.support.version.v1_18_R2.despawnable
...
abstract class DespawnableProvider<T: LivingEntity>(type: DespawnableType): DespawnableProviderCommon<T>(type) {
    ...
    private fun getGoalSelector(entityLiving: EntityCreature) = entityLiving.bQ
    private fun getTargetSelector(entityLiving: EntityCreature) = entityLiving.bR
