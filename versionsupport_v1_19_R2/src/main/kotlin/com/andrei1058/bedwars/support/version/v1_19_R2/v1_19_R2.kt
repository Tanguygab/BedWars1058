...
@Suppress("ClassName")
@Deprecated("")
class v1_19_R2(plugin: Plugin, name: String) : VersionSupportCommon(plugin, name, 9) {
    ...
    override fun registerTntWhitelist(endStoneBlast: Float, glassBlast: Float) {
        ...
        glassBlastBlocks.forEach { field.set(it, glassBlast) }
    }
